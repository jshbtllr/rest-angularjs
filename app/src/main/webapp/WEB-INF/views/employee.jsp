...
<html ng-app="employeemanagement">
	<head>
		<meta charset="UTF-8"/>
		<title><spring:message code="employee.management"></spring:message></title>
		<script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.4.3/angular.min.js"></script>
		<script src="employee.js"></script>
	</head>
	<body>
		<h3><spring:message code="employee.management"></spring:message></h3>
		<h4><spring:message code="current.employee"></spring:message></h4>
		<table width=100%>
